...
export interface BocCard {
  ...
  imageUrl?: string;
  imageAlt?: string;
  imageSource?: 'dataset' | 'unsplash' | 'placeholder';
  rarity: Rarity;
  isStarter: boolean;
  sourceLabel: string;
...
export const CARD_POOL: BocCard[] = [
  {
    ...
    imageUrl: 'https://app.helphousing.com/upload/web/cost-of-living-in-milan-for-students-housing.jpg',
    imageAlt: 'Student housing costs in Milan',
    imageSource: 'dataset',
    rarity: 'rare',
    isStarter: true,
  ...
  },
  {
    ...
    imageUrl: 'https://www.milanocittastato.it/wp-content/uploads/2022/02/centro-di-milano-malpensa-1024x657.jpg',
    imageAlt: 'Milan public transport connection',
    imageSource: 'dataset',
    rarity: 'uncommon',
    isStarter: true,
  ...
  },
  {
    ...
    imageUrl: 'https://www.unibocconi.it/sites/default/files/media/images/_MG_6005.jpg',
    imageAlt: 'Bocconi campus service desk area',
    imageSource: 'dataset',
    rarity: 'uncommon',
    isStarter: true,
  ...
  },
  {
    ...
    imageUrl: 'https://www.unibocconi.it/sites/default/files/styles/link_card/public/media/images/studenti_.jpg.webp?itok=8_QlE0CP',
    imageAlt: 'Bocconi students walking on campus',
    imageSource: 'dataset',
    rarity: 'rare',
    isStarter: true,
  ...
  },
  {
    ...
    imageUrl: 'https://www.unibocconi.it/sites/default/files/styles/fullwidth_xxl/public/media/images/piazza_gae_aulenti_0.jpg.webp?itok=m2__eciS',
    imageAlt: 'Piazza Gae Aulenti in Milan',
    imageSource: 'dataset',
    rarity: 'uncommon',
    isStarter: true,
  ...
  },
  {
    ...
    imageUrl: 'https://www.unibocconi.it/sites/default/files/styles/highlight_slide/public/media/images/pane_quotidiano.jpg.webp?itok=wltEwJhQ',
    imageAlt: 'Food and social engagement near Bocconi campus',
    imageSource: 'dataset',
    rarity: 'common',
    isStarter: true,
  ...
  },
  {
    ...
    imageUrl: 'https://www.unibocconi.it/sites/default/files/styles/key_fact_xxl/public/media/images/gopr0715_cutkf_1.jpg.webp?itok=1JLHf4lu',
    imageAlt: 'Bocconi campus sport facility',
    imageSource: 'dataset',
    rarity: 'common',
    isStarter: true,
  ...
  },
  {
    ...
    imageUrl: 'https://www.unibocconi.it/sites/default/files/styles/link_card/public/media/images/studenti_4.jpg.webp?itok=gdH9KVpy',
    imageAlt: 'Bocconi students gathered on campus',
    imageSource: 'dataset',
    rarity: 'uncommon',
    isStarter: true,
  ...
  },
  {
    ...
    imageUrl: 'https://www.unibocconi.it/sites/default/files/styles/highlight_slide/public/media/images/la_ask-a-librarian.jpg.webp?itok=qDt5pMCB',
    imageAlt: 'Bocconi library support team',
    imageSource: 'dataset',
    rarity: 'common',
    isStarter: true,
  ...
  },
  {
    ...
    imageUrl: 'https://www.unibocconi.it/sites/default/files/styles/fullwidth_xxl/public/media/images/counseling.jpg.webp?itok=pAuc-iwN',
    imageAlt: 'Bocconi counseling and wellbeing support',
    imageSource: 'dataset',
    rarity: 'uncommon',
    isStarter: true,
  ...
  },
  {
    ...
    imageUrl: 'https://www.unibocconi.it/sites/default/files/styles/fullwidth_xxl/public/media/images/_mg_7245_0_0.jpg.webp?itok=bsdBRWTs',
    imageAlt: 'Bocconi students during an international mobility moment',
    imageSource: 'dataset',
    rarity: 'ultra-rare',
    isStarter: true,
  ...
  },
  {
    ...
    imageUrl: 'https://www.unibocconi.it/sites/default/files/styles/fullwidth_xxl/public/media/images/img_2938.jpg.webp?itok=RLGIykym',
    imageAlt: 'Students sitting together during an application activity',
    imageSource: 'dataset',
    rarity: 'uncommon',
    isStarter: true,
  ...
  },
  {
    ...
    imageUrl: 'https://www.unibocconi.it/sites/default/files/styles/fullwidth_xxl/public/media/images/_mg_7245_0.jpg.webp?itok=HKorGv8J',
    imageAlt: 'Bocconi international mobility students',
    imageSource: 'dataset',
    rarity: 'rare',
    isStarter: true,
  ...
  },
  {
    ...
    imageUrl: 'https://www.unibocconi.it/sites/default/files/styles/container_100_lg/public/media/images/summer_school_380x220.jpg.webp?itok=Dsn8s6ud',
    imageAlt: 'Bocconi summer school students outdoors',
    imageSource: 'dataset',
    rarity: 'common',
    isStarter: true,
  ...
  },
  {
    ...
    imageUrl: 'https://www.unibocconi.it/sites/default/files/styles/link_card/public/media/images/undergraduate_bis.jpg.webp?itok=EW2slM6v',
    imageAlt: 'Students in a Bocconi academic setting',
    imageSource: 'dataset',
    rarity: 'uncommon',
    isStarter: true,
  ...
  },
  {
    ...
    imageUrl: 'https://www.unibocconi.it/sites/default/files/styles/highlight_slide/public/media/images/ipp-402.jpg.webp?itok=q3qk9oCr',
    imageAlt: 'BocconiJobs career event',
    imageSource: 'dataset',
    rarity: 'uncommon',
    isStarter: true,
  ...
  },
  {
    ...
    imageUrl: 'https://www.unibocconi.it/sites/default/files/styles/link_card/public/media/images/grants_office_3_0.jpg.webp?itok=_LPI-eQJ',
    imageAlt: 'Bocconi grants office and funding support',
    imageSource: 'dataset',
    rarity: 'rare',
    isStarter: true,
  ...
  },
  {
    ...
    imageUrl: 'https://www.sdabocconi.it/_next/image/?url=https%3A%2F%2Fsda-website-prod-sdawebsiteprodbucketpublic693d05b-w3mwb4fo9x9p.s3.eu-south-1.amazonaws.com%2Fs3fs-public%2F2025-02%2Ffaculty-image-banner-mobile.jpg&w=3840&q=90&dpl=dpl_EgyAUeGYW1L1ERS2WGuDkM3HLa8o',
    imageAlt: 'SDA Bocconi faculty and research banner',
    imageSource: 'dataset',
    rarity: 'common',
    isStarter: true,
  ...
  },
  {
    ...
    imageUrl: 'https://www.unibocconi.it/sites/default/files/styles/highlight_slide/public/media/images/bocconi_phvbettoja_bev_13821_0.jpg.webp?itok=FkNBF8rU',
    imageAlt: 'Bocconi career and alumni network moment',
    imageSource: 'dataset',
    rarity: 'uncommon',
    isStarter: true,
