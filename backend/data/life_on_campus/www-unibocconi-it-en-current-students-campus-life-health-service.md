...
language: en
source_url: https://www.unibocconi.it/en/current-students/campus-life/health-service
last_updated: '2026-05-02'
title: Health service | Bocconi University
token_estimate: 2764
---

Campus Life

[Overview](https://www.unibocconi.it/en/current-students/campus-life)
...
2. Accessing the system for occasional medical examinations
...
By presenting the payment receipt for the service to the ASL of residence, you are entitled to reimbursement of the expenses incurred by the ASL of residence.
...
Consult the list of general practitioners in the Milan area: [ATS Milano - Doctor Search](https://www.ats-milano.it/portale/Cerca-medico-o-pediatra) For more information, please consult the [ATS Milano](https://www.ats-milano.it/portale) website or call the toll-free number +39 02.85.781

EU Students

_The following information is valid for citizens from a European Union country, the European Economic Area or Switzerland_
...
To register for the Regional Health Service, you must go to the ["Scelta e Revoca" counter](https://www.dati.lombardia.it/Government/Sportelli-Scelta-Revoca/6ppc-jasq) at ATS Milano, with a photocopy of a valid ID and fiscal code and with the completed S1 form.

Consult the European Union website for more information on the social security institutions of member countries: [Social Security Coordination Institution](https://ec.europa.eu/social/social-security-directory/pai/pai/select-country/language/en)

STAYS SHORTER THAN 3 MONTHS

If you are in Italy for a period shorter than 3 months, healthcare is guaranteed through the [European Health Insurance Card](https://ec.europa.eu/social/main.jsp?catId=563&langId=it#nationalinfo) (EHIC), which entitles you to receive necessary, including non-urgent, treatment under the same conditions and at the same cost (free of charge in some countries) of clients in the country where you are located. These cards are issued by the insurance body of the country of residence.
...
To do this, you must go to the [**"Scelta e Revoca" counter**](https://www.dati.lombardia.it/Government/Sportelli-Scelta-Revoca/6ppc-jasq) **at ATS Milano** with the following documents:
...
[SALUTILE Pronto Soccorso](https://www.regione.lombardia.it/wps/portal/istituzionale/HP/DettaglioServizio/servizi-e-informazioni/Cittadini/salute-e-prevenzione/Emergenze-e-urgenze/salutile-pronto-soccorso) is an app from the Lombardy Region which can be used to consult the list of all Emergency Rooms in the Lombardy Region. You can also see the number of people queuing at that time and the crowding index.
...
The Continuity of Care Service ( _Continuità Assistenziale_, formerly _Guardia Medica_) intervenes during the hours when general practitioners' offices are closed, for illnesses that cannot be treated by an attending physician the following day, therefore in the event that it cannot be postponed.
...
[More…](https://www.unibocconi.it/en/current-students/campus-life/health-service#addtoany "Show all")
