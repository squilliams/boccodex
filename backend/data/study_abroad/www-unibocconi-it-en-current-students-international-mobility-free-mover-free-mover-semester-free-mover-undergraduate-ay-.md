...
language: en
source_url: https://www.unibocconi.it/en/current-students/international-mobility/free-mover/free-mover-semester/free-mover-undergraduate-ay-2024-25
last_updated: '2026-05-02'
title: Free Mover Undergraduate a.y. 2024-25 | Bocconi University
token_estimate: 1427
---
...
# Free Mover Undergraduate a.y. 2024-25

Please refer to the a.y. 2024-25 Guide, in order to get all the necessary information in terms of: academic and language requirements, possible destinations, application procedure and timeline, academic recognition.
...
- **Course year:** the period abroad must be the 1st or 2nd semester of the 3rd year;
- **Credits:** at least **60%** of 1st year credits registered before semesters departures (the Exchange Program rules on credits apply).
- **Language Requirements:** Language of instruction of the Host University - the Exchange Program language applies\*.

\*  The language and level of selection indicated  by Università Bocconi in the Exchange Program destinations is to be considered **compulsory** also for Free-Movers.
...
**Language:** The language required — but not the additional requirements if any - is the same as that indicated by Università Bocconi for the Exchange Program and it is compulsory **also** for the Free-Movers.
...
The list of foreign Universities is to be considered as **the only valid list** in termsof possibility of recognition of the tuition received by Free-Mover Semesterstudents at foreign institutions.
...
Please refer to this [**link**](https://www.unibocconi.eu/wps/wcm/connect/bocconi/sitopubblico_en/navigation+tree/home/programs/current+students/services/international+relations/bocconi+students/undergraduate+school/study+abroad/what/free+mover+semester/how+to+collect+info_edauthor+2008+06+26+12+09), in order to get all the necessary information in terms of: selection process, application procedure & timeline.
...
The conversion procedure is similar to the one applied to the Exchange Program ("Academic Recognition" chapter). Only upon admission is the table of conversion of grades available at Punto Blu _and_ it is also available in the Exchange Program dynamic brochure for reference.

Undergraduate Free-Mover Semester students can have **a maximum of 5 Bocconi courses** recognised once back from their experience abroad.

Contact us

B in Touch available on the yoU@B Diary
...
- [Partners which don't accept FreeMovers from Bocconi 2023-24](https://www.unibocconi.it/sites/default/files/Partners_which_DONT_accept_FreeMovers_from_Bocconi_2023-24WEB_20230623.pdf)
- [Possible destinations 23-24](https://www.unibocconi.it/sites/default/files/POSSIBLE%2BDESTINATIONS%2B23-24%2Bweb%2BApril%2B20230524.pdf)

[More…](https://www.unibocconi.it/en/current-students/international-mobility/free-mover/free-mover-semester/free-mover-undergraduate-ay-2024-25#addtoany "Show all")
