...
language: en
source_url: https://www.sdabocconi.it/en/specialized-master-full-time-executive/mims/admissions/
last_updated: '2026-05-02'
title: MiMS - Admissions | SDA Bocconi
token_estimate: 3920
---

Master in Management per la Sanità

[Apply Now](https://apply.sdabocconi.it/it_IT/courses/course/29-mims-master-management-per-la-sanita) [Download brochure](https://www.sdabocconi.it/en/specialized-master-full-time-executive/mims/downloadbrochure/) [Open wishlist form](https://www.sdabocconi.it/en/specialized-master-full-time-executive/mims/wishlist/)

Admissions

## Selection and admission process

The selection process is based on a comprehensive analysis of the documentation received and other elements, and aims to attain a highly qualified, motivated class capable of contributing to a dynamic and stimulating learning environment. We assess not only whether you are the right profile for MiMS, but also whether MiMS meets your expectations.

Admission involves a rigorous selection process, which evaluates the personal motivations, educational background, and professional experience (including brief) of candidates, with special emphasis on interest in the healthcare field. Each year, MiMS welcomes young, highly motivated, and culturally innovation-oriented people, qualities essential to understanding the logic of how the industry operates and contributing to its constant evolution. The selection thus ensures the formation of a class in which talented individuals can not only pursue their professional and personal goals but also enrich the classroom learning experience.

###### Deadlines

**Tuition waivers**

1st round: 30 June 2026

2nd round: 30 September 2026

3rd round: 25 November 2026

**Application**

25 November 2026

![Direttrice MIMS](https://www.sdabocconi.it/_next/image/?url=https%3A%2F%2Fsda-website-prod-sdawebsiteprodbucketpublic693d05b-w3mwb4fo9x9p.s3.eu-south-1.amazonaws.com%2Fs3fs-public%2F2025-04%2Fcard_mims.jpg&w=3840&q=90&dpl=dpl_EgyAUeGYW1L1ERS2WGuDkM3HLa8o)
...
The following documents must be uploaded to the relevant section of the **portal Application** for admission and submitted to the Admissions team:

### Detailed CV

### Qualification Certificate (Degree)

### Certifications for English language proficiency

### 'Sponsor Company' form
...
You will receive the official admission notice along with the participation contract. You must confirm your participation by the deadline specified by the Admissions committee. If all available spots have been filled, the school may place you on a waiting list or offer admission for the following edition. Admission to the program is valid for the year the application is submitted. However, you can request deferment to the following year, but approval of deferment is on a case-by-case decision by the Admissions committee.

**Non-admission:**

the selection process evaluates not only the individual profile but also the overall composition of the MiMS class. While we acknowledge the significant effort all candidates invest in the application and the selection process, we do not provide personalized feedback to non-admitted candidates.
...
**Please note that the application portal is a separate platform, so your SDA Bocconi website (https://www.sdabocconi.it) credentials are not to be used. Please proceed with a new registration.**
...
[+39 02 5836 3119 - 3215](tel:+390258363119) [admissions.mims@sdabocconi.it](mailto:admissions.mims@sdabocconi.it)

## We look for highly motivated candidates with well-defined goals

The selection process for MiMS 2027 is **rolling** and runs from February to 25 November 2026.

The outcome of admissions will be announced within a few weeks after the application is submitted and the selection process is completed. Due to the limited availability of places, we recommend that you start the admission process well in advance of the Master program start date.

To increase your chances of admission, please submit your application as soon as possible.

[Go to fees and expenses](https://www.sdabocconi.it/en/specialized-master-full-time-executive/mims/fees-and-scholarships/#fees-expenses) [Go to scholarships and tuition waivers](https://www.sdabocconi.it/en/specialized-master-full-time-executive/mims/fees-and-scholarships/#scholarships)
...
Want to know more about MiMS?

[Contact us](https://www.sdabocconi.it/en/specialized-master-full-time-executive/mims/requestinformation/) [Download brochure](https://www.sdabocconi.it/en/specialized-master-full-time-executive/mims/downloadbrochure/)
